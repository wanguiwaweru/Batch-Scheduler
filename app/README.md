...
```mermaid
flowchart TD
    A[Job Queue<br/>Priority ordered] --> B[Filter Phase<br/>Check CPU and memory<br/>and basic feasibility]
    B --> C[Score Phase<br/>Rank nodes by capacity<br/>and data locality]
    C --> D[Select and Bind<br/>Assign job to best node]
```
